      ...
      <div class="content_res">
        ...
        <div class="content_left">
            ...
            <div class="shadowblock">
                ...
                <h1 class="single dotted"><?php printf(__("%s's Dashboard", 'appthemes'), $current_user->user_login); ?></h1>
                ...
                <table border="0" cellpadding="4" cellspacing="1" class="tblwide">
                    <thead>
                        <tr>
							...
							<!--	Commented Nov 4 2013 - <th width="40px"><?php //_e('Views','appthemes');?></th>-->
					...
					<?php if(have_posts()) : ?>
                        ...
                        <?php                     
							...
							// Commented Nov 4 2013 - if (get_post_meta($post->ID, 'cp_total_count', true))
							//	Commented Nov 4 2013 - $ad_views = number_format(get_post_meta($post->ID, 'cp_total_count', true));
							//	Commented Nov 4 2013 - else
							//	Commented Nov 4 2013 - 	$ad_views = '-';
