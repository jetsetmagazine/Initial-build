 ...
 * @since 1.1
 */
function appthemes_before_loop() {
	do_action( 'appthemes_before_loop' );
}
 ...
 * @since 1.1
 */
function appthemes_before_post() {
	do_action( 'appthemes_before_post' );
}
 ...
 * @since 1.1
 */
function appthemes_before_post_title() {
	do_action( 'appthemes_before_post_title' );
}
 ...
 * @since 1.1
 */
function appthemes_after_post_title() {
	do_action( 'appthemes_after_post_title' );
}
 ...
 * @since 1.1
 */
function appthemes_before_post_content() {
	do_action( 'appthemes_before_post_content' );
}
 ...
 * @since 1.1
 */
function appthemes_after_post_content() {
	do_action( 'appthemes_after_post_content' );
}
 ...
 * @since 1.1
 */
function appthemes_after_post() {
	do_action( 'appthemes_after_post' );
}
 ...
 * @since 1.1
 */
function appthemes_after_endwhile() {
	do_action( 'appthemes_after_endwhile' );
}
 ...
 * @since 1.1
 */
function appthemes_loop_else() {
	do_action( 'appthemes_loop_else' );
}
 ...
 * @since 1.1
 */
function appthemes_after_loop() {
	do_action( 'appthemes_after_loop' );
}
