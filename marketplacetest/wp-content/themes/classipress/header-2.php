...
<meta http-equiv="refresh" content="0;URL=http://www.jetsetmag.com/marketplace.html"> 
<meta name="robots" content="noindex, nofollow">

<meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php bloginfo('charset'); ?>" />

<title>Jetset Marketplace</title> 
...
<div class="top" style="width:<?php echo $topsize[0]; ?>px; height:<?php echo $topsize[1]; ?>px;"></div>
...
<div style="margin-left:auto; margin-right:auto; width:150px; position:relative;left:393px;top:-595px;z-index:2; font-family:Verdana, Geneva, sans-serif; font-size:9px; vertical-align:middle;">
	...
	<a href="http://www.youtube.com/user/jetsetmagazine" target="_blank"><img src="http://www.jetsetmag.com/youtube.png" border="0" style="position: relative; left:5px;" alt="Jetset Magazine on YouTube"></a>
	<a href="http://www.facebook.com/pages/Jetset-Magazine/247858190983" target="_blank"><img src="http://www.jetsetmag.com/facebook.png" border="0" style="position: relative; left:5px;" alt="Jetset Magazine on Facebook"></a>
&nbsp;
	<iframe src="https://www.facebook.com/plugins/like.php?href=https://www.facebook.com/JetsetOnline" scrolling="no" frameborder="0" style="border:none; width:50px; height:25px"></iframe><br />
	<a style="padding-left:5px; font-size:9px;" href="http://www.jetsetmag.com/view-magazines.html#nav">Login</a>&nbsp;&nbsp;<a style="padding-left:5px; font-size:9px;" href="http://www.jetsetmag.com/access.html#nav">Logout</a>
	<a style="padding-left:5px; font-size:9px;" href="http://www.jetsetmag.com/view-magazines.html#nav">View Issues</a>&nbsp;
