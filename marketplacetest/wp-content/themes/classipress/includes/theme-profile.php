        ...
        <table class="form-table">
			...
			foreach ( $appthemes_extended_profile_fields as $field_id => $field_values ) :
				...
				switch ($field_values['type']):
					...
					case 'date':
				?>
								<input type="text" name="<?php echo $field_id; ?>" id="<?php echo $field_id; ?>" value="<?php esc_attr_e( $the_value ); ?>" class="regular-text" size="35" <?php if(!empty($protected)) echo 'style="display: none;"'; ?> required="required" /><br />
                                <input type="text" name="<?php echo $field_id; ?>_display" id="<?php echo $field_id; ?>" value="<?php esc_attr_e( appthemes_display_date($the_value) ); ?>" class="regular-text" size="35" disabled="disabled" required="required" /><br />
				...
				?>
								<input type="text" name="<?php echo $field_id; ?>" id="<?php echo $field_id; ?>" value="<?php esc_attr_e( $the_value ); ?>" class="regular-text" size="35" <?php if(!empty($protected)) echo 'style="display: none;"'; ?> required="required" /><br />
                                <input type="text" name="<?php echo $field_id; ?>_display" id="<?php echo $field_id; ?>" value="<?php esc_attr_e( $the_display_value ); ?>" class="regular-text" size="35" disabled="disabled" required="required" /><br />
								<span class="description"><?php echo $field_values['description']; ?></span>
				<?php
					break;
