   ...
   <img src="<?php bloginfo('template_url'); ?>/images/step3.gif" alt="" class="stepimg" />
    ...
    // otherwise the ad was free and show the thank you page.
        ...
        ?>
            ...
            <p><?php _e('<br>You can check the status of your ad by clicking on the <strong>&quot;Manage Ads&quot;</strong> button above. Once you have clicked <strong>&quot;Manage Ads,&quot;</strong> you may edit any pre-existing ads that you have posted by clicking on the pencil icon next to the listing.<br><br> Please note: Your ad may take up to 48 hours to be reviewed and receive approval.','appthemes') ?></p>
