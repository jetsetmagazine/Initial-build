...
<?php endif; ?>
  ...
  <div id="textinputwrap">
	...
	<?php if ($user_ID) : ?>
		...
		<p class="logged"  id="respond"><?php _e( "Logged in as", "wptouch" ); ?> <span><?php echo $user_identity; ?></span>:</p>
	...
	<?php endif; ?>
		...
		<p>
			<input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Publish Comment &rarr;', 'wptouch'); ?>	" />
