	        ...
	        <div id="menu-head">
	        	<div id="tabnav">
	    	    	...
	    	    	<?php if (bnc_is_login_button_enabled()) { ?>
						...
						<?php } else { ?>
							 <a href="#head-account"><?php _e( "My Options", "wptouch" ); ?></a>
						<?php } ?>
					<?php } ?>
	        	</div>
	
				<ul id="head-pages">
					<?php rb_wptouch_core_header_home(); ?>            
					<?php rb_wptouch_core_header_pages(); ?>
					<?php rb_wptouch_core_header_rss(); ?>
					<?php rb_wptouch_core_header_email(); ?>           
				</ul>
