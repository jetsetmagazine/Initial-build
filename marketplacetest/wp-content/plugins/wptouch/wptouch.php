...
Author: Classipro (alucas & Rubencio)
...
function do_test()
{
    ...
    if(get_option($app_abbr.'_ad_cat_tax_permalink')) $cat_tax_base_url = get_option($app_abbr.'_ad_cat_tax_permalink'); else $cat_tax_base_url = 'ad-category'; // patch toni
    ...
    register_post_type( APP_POST_TYPE,
        array( 'labels' => array(
            'name' => __( 'Ads', 'wptouch' ),
            'singular_name' => __( 'Ad', 'wptouch' ),
            'add_new' => __( 'Add New', 'wptouch' ),
            'add_new_item' => __( 'Create New Ad', 'wptouch' ),
            'edit' => __( 'Edit', 'wptouch' ),
            'edit_item' => __( 'Edit Ad', 'wptouch' ),
            'new_item' => __( 'New Ad', 'wptouch' ),
            'view' => __( 'View Ads', 'wptouch' ),
            'view_item' => __( 'View Ad', 'wptouch' ),
            'search_items' => __( 'Search Ads', 'wptouch' ),
            'not_found' => __( 'No ads found', 'wptouch' ),
            'not_found_in_trash' => __( 'No ads found in trash', 'wptouch' ),
            'parent' => __( 'Parent Ad', 'wptouch' ),
            ),
            'description' => __( 'This is where you can create new classified ads on your site.', 'wptouch' ),
            'public' => true,
            'show_ui' => true,
    ...
    register_taxonomy( APP_TAX_CAT,
            ...
            array('hierarchical' => true,
                  'labels' => array(
                        'name' => __( 'Ad Categories', 'wptouch'),
                        'singular_name' => __( 'Ad Category', 'wptouch'),
                        'search_items' =>  __( 'Search Ad Categories', 'wptouch'),
                        'all_items' => __( 'All Ad Categories', 'wptouch'),
                        'parent_item' => __( 'Parent Ad Category', 'wptouch'),
                        'parent_item_colon' => __( 'Parent Ad Category:', 'wptouch'),
                        'edit_item' => __( 'Edit Ad Category', 'wptouch'),
                        'update_item' => __( 'Update Ad Category', 'wptouch'),
                        'add_new_item' => __( 'Add New Ad Category', 'wptouch'),
                        'new_item_name' => __( 'New Ad Category Name', 'wptouch')
                    ),
                    'show_ui' => true,
                    'query_var' => true,
    ...
    register_taxonomy( APP_TAX_TAG,
            ...
            array('hierarchical' => false,
                  'labels' => array(
                        'name' => __( 'Ad Tags', 'wptouch'),
                        'singular_name' => __( 'Ad Tag', 'wptouch'),
                        'search_items' =>  __( 'Search Ad Tags', 'wptouch'),
                        'all_items' => __( 'All Ad Tags', 'wptouch'),
                        'parent_item' => __( 'Parent Ad Tag', 'wptouch'),
                        'parent_item_colon' => __( 'Parent Ad Tag:', 'wptouch'),
                        'edit_item' => __( 'Edit Ad Tag', 'wptouch'),
                        'update_item' => __( 'Update Ad Tag', 'wptouch'),
                        'add_new_item' => __( 'Add New Ad Tag', 'wptouch'),
                        'new_item_name' => __( 'New Ad Tag Name', 'wptouch')
                    ),
                    'show_ui' => true,
                    'query_var' => true,
					'update_count_callback' => '_update_post_term_count',
